...
public class DetectionSRF10 {
	 ...
	 * @throws IOException 
	 */
	public DetectionSRF10(int i2cdev, int avantGauche, int avantDroit, int arriere, int echantillon, int seuil) throws IOException {
	 ...
	 * @throws IOException 
	 */
	public int mesureAvantGauche() throws IOException {
	 ...
	 * @throws IOException 
	 */
	public int mesureAvantDroit() throws IOException {
	 ...
	 * @throws IOException 
	 */
	public int mesureArriere() throws IOException {
	 ...
	 * @throws IOException 
	 */
	public boolean detectionAvant() throws IOException {
	 ...
	 * @throws IOException 
	 */
	public boolean detectionArriere() throws IOException {
