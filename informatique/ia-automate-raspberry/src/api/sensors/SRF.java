...
public class SRF {
	 ...
	 *            et 0x7F)
	 */
	public SRF(int i2cdev, int i2caddr) {
		this.i2cdev = i2cdev;
	 ...
	 */
	public int getInches(int sleepms) {
	 ...
	 * @see {@link #getInches()}
	 */
	public int getMicroSeconds(int sleepms) {
	 ...
	 * @see {@link #getInches()}
	 */
	public int getCentimeters(int sleepms) {
